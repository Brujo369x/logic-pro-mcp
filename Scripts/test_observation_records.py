...
#     A locale named inside a READING is checked too. Found by review 2026-09-08: the ratchet
...
case("a reading in a second SUPPORTED locale is accepted",
     problems(record(observations=[{"what": "a reading", "count": 3, "locale": "ja-JP"}])) == [],
     "a record may exercise more than one locale the axis carries")
